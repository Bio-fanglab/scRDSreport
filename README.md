...
[![R-CMD-check](https://github.com/Bio-fanglab/scRDSreport/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/Bio-fanglab/scRDSreport/actions/workflows/R-CMD-check.yaml)
[![Example report](https://img.shields.io/badge/online-example-1177A3)](https://bio-fanglab.github.io/scRDSreport/report.html)
...
**[查看 10x Genomics 官方示例数据生成的在线报告](https://bio-fanglab.github.io/scRDSreport/report.html)** · [快速开始](#快速开始) · [安装](#安装) · [完整分析说明](docs/full-analysis.md)
...
```r
source(
  "https://raw.githubusercontent.com/Bio-fanglab/scRDSreport/main/inst/install_scRDSreport.R"
)
